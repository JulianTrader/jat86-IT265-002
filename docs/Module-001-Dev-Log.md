...
- [ ] Goal 3
-->
- [✅] Come up with a studio idea and complete the studio brainstorm assignment
- [✅] Set up a Github webpage 
- [✅] Set up Learn account and Discord 
...
- **Solutions**:
  ...
  everyone happy. For designing the logo, I opted for a more simple design but I didn't want it to be straight up boring. So after a bit of tweaking and experimenting I was eventually able to 
  come up with something that satisfied me for the most part. I would like to do more with it, but I didn't want to spend too much time on the logo. I spent a lot of time changing colors, sizes,
  designs, etc. I drew the FLARE part by hand, but just used text for the Ware part since I wanted it to be more simple. For the A and R, I spent a bit of time trying to decide whether or not 
  I should put the holes in. After trying it out, I ended up no liking how it looked with the holes so I chose to leave it closed as a stylistic choice. The A and R are still recognizable enough
